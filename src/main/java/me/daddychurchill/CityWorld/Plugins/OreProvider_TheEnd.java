...
public class OreProvider_TheEnd extends OreProvider {
    ...
    public OreProvider_TheEnd(CityWorldGenerator generator) {
        ...
        ore_types.add(
                generator.materialProvider.itemsMaterialListFor_TheEndOres.getNthMaterial(3, Material.QUARTZ_BLOCK));
        ore_types.add(generator.materialProvider.itemsMaterialListFor_TheEndOres.getNthMaterial(4, Material.GLOWSTONE));

        ore_types.add(
                generator.materialProvider.itemsMaterialListFor_TheEndOres.getNthMaterial(5, Material.PURPUR_BLOCK));
        ...
        ore_types.add(
                generator.materialProvider.itemsMaterialListFor_TheEndOres.getNthMaterial(8, Material.DIAMOND_ORE));
